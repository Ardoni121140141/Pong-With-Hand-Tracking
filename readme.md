...
| Week 2 | - Creating a Paddle in a Pong Game (`paddle.py`) <br> - Creating a Pong game using Pygame, Creating a collision detection system and check the winner (`game.py`) <br> - Implementing hand tracking using MediaPipe for Game Pong (`main.py`) <br> | Ardoni Yeriko & Kevin Simorangkir & Rizki Alfaina | Done |